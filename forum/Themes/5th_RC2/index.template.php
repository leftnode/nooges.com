...
<div class="tl"></div><div class="tr"></div>';
	...
	if (!empty($settings['header_logo_url']))
		echo '
				<a href="', $scripturl, '"><img class="marginbottom" src="', $settings['header_logo_url'], '" alt="', $context['forum_name_html_safe'], '" /></a>';
...
<div class="rborder margin">
  ...
  <div class="bl"></div><div class="br"></div>
	...
	echo '
		...
		<div id="upper_section" class="middletext rborder2 margin"', empty($options['collapse_header']) ? '' : ' style="display: none;"', '>
  <div class="tl"></div><div class="tr"></div>
			<div class="user">';
